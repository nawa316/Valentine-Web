        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className={`${isVisible ? "block" : "hidden"} w-full md:block md:w-auto`} id="navbar-default">
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg bg-[#FFCFCF] md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-[#FFCFCF] dark:bg-[#FFCFCF] md:bg-[#FFCFCF]">
              <li>
                <Link href="/" className="block py-2 px-3 text-[#FF3253] bg-[#FFFDEC] rounded md:bg-transparent md:text-[#FF3253] md:p-0 dark:text-[#FF3253] md:dark:text-[#FF3253]" aria-current="page">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/valentine" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#FF3253] md:p-0 dark:text-white md:dark:hover:text-[#FF3253] dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                  Valentine
                </Link>
              </li>
            </ul>
